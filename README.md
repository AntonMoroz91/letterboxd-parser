...
## 📌 Постановка задачи
Разработать парсер для сайта Letterboxd, который по логину пользователя собирает информацию о всех фильмах, добавленных в дневник: название, год выпуска и оценку. Результат сохраняется в формате Excel, CSV или JSON для дальнейшего анализа.
